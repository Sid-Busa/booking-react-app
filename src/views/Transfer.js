...
function Transfer(props) {
  ...
  const handleChange = (event) => {
    if (event.target.name === "checkedWheelchairAccess" && !state.checkedWheelchairAccess) {
      setAddedNote(addedNote + "Wheelchair Accessible Vehicle: ");
    } else if (event.target.name === "checkedWheelchairAccess" && state.checkedWheelchairAccess) {
      setAddedNote(addedNote.replace("Wheelchair Accessible Vehicle: ", ""));
    }

    if (event.target.name === "checkedBulkyLuggage" && !state.checkedBulkyLuggage) {
      setAddedNote(addedNote + "Bulky luggage: ");
    } else if (event.target.name === "checkedBulkyLuggage" && state.checkedBulkyLuggage) {
  ...
  console.log(getCarsFromPassengerNumber(10));
        ...
        <Grid container md={8} spacing={2}>
            ...
            <Card className={classes.bookingDetailsCard}>
              <CardContent>
                <Grid item md={12} className={classes.bookingDetailsTitleGrid}>
                  <Typography variant="h5" className={classes.bookingDetailsTitle}>
                    Booking Details
                  </Typography>
                </Grid>
                ...
                <Grid item md={12} className={classes.checkboxGrid}>
                  <FormControlLabel control={<Checkbox checked={state.checkedB} onChange={handleChange} name="checkedB" />} label="Add child seats" />
                  {state.checkedB ? (
                    <>
                      <Grid item md={12} style={{ margin: 20 }}>
                        ...
                        >
                          <Grid alignItems="center" md={4}>
                            <Typography variant="subtitle1">Infant Carrier</Typography>
                            <Typography variant="paragraph" color="textSecondary" style={{ fontSize: 14 }}>
                              0-6 months
                            </Typography>
                          </Grid>
                ...
                <Grid item md={12} className={classes.checkboxGrid}>
                  ...
                  {state.checkedC ? (
                    <Grid item md={12} style={{ margin: 20 }}>
                      ...
                      <FormControlLabel
                        control={<Checkbox checked={state.checkedBulkyLuggage} onChange={handleChange} name="checkedBulkyLuggage" />}
                        label="Bulky luggage"
                      />

                      <FormControlLabel
                        control={<Checkbox checked={state.checkedWheelchairAccess} onChange={handleChange} name="checkedWheelchairAccess" />}
              ...
              <CardActions>
                <Grid container justify="center">
                  <Grid item md={12}>
                    <Button onClick={submit} size="small" className={classes._continueButton} variant="outlined">
                      Continue
                    </Button>
                  </Grid>
                </Grid>
          ...
          <Grid item md={5} container>
            <Grid style={{ position: "relative", paddingBottom: "20px" }} item md={12}>
              <OrderSummary details={details} handleOpen={handleOpen} destTitle={destTitle} destAddress={destAddress} allDetails={allDetails} />
              <Modal open={IsOpen} onClose={handleClose} aria-labelledby="simple-modal-title" aria-describedby="simple-modal-description">
                <div className={classes.popUp}>
                  <BookingForm customForm="editForm" details={details} handleClose={handleClose} />
                </div>
              </Modal>
            </Grid>
            <Grid item md={12}>
